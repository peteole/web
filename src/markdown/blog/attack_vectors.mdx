...
seo:
  ...
  keywords: |
    attack vectors, auth, security, phishing attack
...
- Consider using [WebAuthn](https://webauthn.io/) for passwordless flows in browser

## Conclusion

I hope that reading this article gave you a brief introduction to the most common attack vectors and how you can avoid vulnerabilities in your enterprise. Besides the attack vectors mentioned in this blog post, it is essential to note that insecure practices by employees can be a significant vulnerability related to the authentication process. After all, employees are the weakest link, and attack vectors such as phishing attacks are designed to exploit this vulnerability.
