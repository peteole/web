...
[The full source code for this tutorial is available on GitHub](https://github.com/ory/examples/tree/master/kratos-oathkeeper-kong).
...
<CodeFromRemote
  src="https://github.com/ory/examples/blob/master/kratos-oathkeeper-kong/world/main.go"
  lang="go"
/>
...
<CodeFromRemote
  src="https://github.com/ory/examples/blob/master/kratos-oathkeeper-kong/hello/main.go"
  lang="go"
/>
...
<CodeFromRemote
  src="https://github.com/ory/examples/blob/master/kratos-oathkeeper-kong/docker-compose.yml"
  lang="yaml"
...
<CodeFromRemote
  src="https://github.com/ory/examples/blob/master/kratos-oathkeeper-kong/oathkeeper/access-rules.yml"
  lang="yaml"
/>
...
<CodeFromRemote
  src="https://github.com/ory/examples/blob/master/kratos-oathkeeper-kong/oathkeeper/oathkeeper.yml"
  lang="yaml"
/>
