...
[GitHub](https://github.com/ory/examples/tree/master/kratos-keto-flask). We'll use
...
[contrib/quickstart/kratos/email-password](https://github.com/ory/kratos/tree/master/kratos-keto-flask/contrib/quickstart/kratos/email-password)
to the root of your project and then add the following content to the
docker-compose:

<CodeFromRemote
  lang="yml"
  src="https://github.com/ory/examples/blob/master/kratos-keto-flask/docker-compose.yml"
...
<CodeFromRemote
  lang="yml"
  src="https://github.com/ory/examples/blob/master/kratos-keto-flask/keto/keto.yml"
...
<CodeFromRemote
  lang="yml"
  src="https://github.com/ory/examples/blob/master/kratos-keto-flask/app/public/views.py"
  startAt="HTTP_STATUS_FORBIDDEN = 403"
/>

You can find the full code used for this blog post on
[GitHub](https://github.com/ory/examples/tree/master/kratos-keto-flask).
