...
details. Ensure that your build works:
...
To separate Ory Kratos deployments for staging, production, and development, use
different SDK URLs for the different environments by un/selecting the checkboxes
in the Vercel UI:
...
Adding end-to-end tests is also straightforward! Clone the repository and run
