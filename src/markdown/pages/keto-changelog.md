...
published: true
path: '/keto-changelog/'
title: 'Ory Keto Changelog'
metaTitle: 'Ory Keto Changelog'
metaDescription: 'Ory Keto Changelog'
lastUpdatedAt: 'April 29, 2022'
---

[Visit the source for the Ory Keto Changelog on GitHub.](https://github.com/ory/keto/blob/master/CHANGELOG.md)
