---
published: true
path: '/kratos-changelog/'
title: 'Ory Kratos Changelog'
metaTitle: 'Ory Kratos Changelog'
metaDescription: 'Ory Kratos Changelog'
lastUpdatedAt: 'April 29, 2022'
---

[Visit the source for the Ory Kratos Changelog on GitHub.](https://github.com/ory/kratos/blob/master/CHANGELOG.md)
